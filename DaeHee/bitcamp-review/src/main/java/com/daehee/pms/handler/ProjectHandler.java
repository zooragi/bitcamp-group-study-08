...
public class ProjectHandler {
	...
	public ProjectHandler(List list, MemberHandler memberHandler) {
	...
	public void list() {
		...
		for (Object obj : list) {
			...
			System.out.printf("%d, %s, %s, %s, %s, [%s]\n", project.no, project.title, project.startDate,
					project.endDate, project.owner, project.members);
		}
	}
	...
	public void update() {
		...
		String owner = promptOwner(String.format("만든이(%s)?(취소: 빈 문자열) ", project.owner));
		if (owner == null) {
